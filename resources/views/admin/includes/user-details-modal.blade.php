...
<!-- User Crypto Wallets -->
<div id="user-crypto-modal" tabindex="-1" aria-hidden="true"
    class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        <!-- Modal content -->
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <ul class="my-4 space-y-3">
                            <li class="mb-3">
                                <a href="#"
                                    ...
                                    <span class="flex-1 text-sm ms-3 whitespace-nowrap px-3">{{ $wallet->asset->name }}
                                        ({{ $wallet->asset->slug }})</span>
                                    <span
                                        class="inline-flex items-center justify-center px-2 py-0.5 ms-3 text-xs font-medium text-white rounded">
                                        <span data-modal-target="edit-crypto-wallet-modal"
                                            data-modal-toggle="edit-crypto-wallet-modal"
                                            wire:click="selectWallet('{{ $wallet->id }}')"
                                            type="button"><x-icons.edit /></span>
                                        <span wire:click="deleteWallet('{{ $wallet->id }}')"
                                            wire:confirm="Are you sure you want to delete this wallet?">
                                            <x-icons.trash /></span>
                                    </span>
                                </a>
                            </li>
