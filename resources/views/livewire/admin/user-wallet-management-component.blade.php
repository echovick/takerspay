            ...
            <div class="bg-white rounded-xl shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
                ...
                <form wire:submit="processDeposit" class="px-6 py-4">
                    <div class="space-y-4">
                        <!-- Wallet Type -->
                        <div>
                            <label for="depositWalletType" class="block text-sm font-medium text-gray-700 mb-1">Wallet Type *</label>
                            ...
                            @error('depositWalletType') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                        </div>

                        <!-- Amount -->
                        <div>
                            <label for="depositAmount" class="block text-sm font-medium text-gray-700 mb-1">Amount *</label>
                            <input type="number" wire:model="depositAmount" id="depositAmount" step="0.01" min="0.01"
                                placeholder="0.00"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 text-sm">
                        ...
                        <!-- Description -->
                        <div>
                            <label for="depositDescription" class="block text-sm font-medium text-gray-700 mb-1">Description *</label>
            ...
            <div class="bg-white rounded-xl shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
                ...
                <form wire:submit="processWithdraw" class="px-6 py-4">
                    <div class="space-y-4">
                        <!-- Wallet Type -->
                        <div>
                            <label for="withdrawWalletType" class="block text-sm font-medium text-gray-700 mb-1">Wallet Type *</label>
                            ...
                            @error('withdrawWalletType') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                        </div>

                        <!-- Amount -->
                        <div>
                            <label for="withdrawAmount" class="block text-sm font-medium text-gray-700 mb-1">Amount *</label>
                            <input type="number" wire:model="withdrawAmount" id="withdrawAmount" step="0.01" min="0.01"
                                placeholder="0.00"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-emerald-500 focus:border-emerald-500 text-sm">
                        ...
                        <!-- Bank Account -->
                        <div>
                            <label for="withdrawBankAccount" class="block text-sm font-medium text-gray-700 mb-1">Bank Account *</label>
                            ...
                            @error('withdrawBankAccount') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                            @if(empty($availableBankAccounts))
                                <p class="text-yellow-600 text-xs mt-1">No active bank accounts found for this user.</p>
                            @endif
                        </div>

                        <!-- Description -->
                        <div>
                            <label for="withdrawDescription" class="block text-sm font-medium text-gray-700 mb-1">Description *</label>
            ...
            <div class="bg-white rounded-xl shadow-xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
                ...
                <form wire:submit="processTransfer" class="px-6 py-4">
                    <div class="space-y-4">
                        <!-- From Wallet -->
                        <div>
                            <label for="transferFromWalletType" class="block text-sm font-medium text-gray-700 mb-1">From Wallet *</label>
                            ...
                            @error('transferFromWalletType') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                        </div>

                        <!-- Amount -->
                        <div>
                            <label for="transferAmount" class="block text-sm font-medium text-gray-700 mb-1">Amount *</label>
                            <input type="number" wire:model="transferAmount" id="transferAmount" step="0.01" min="0.01"
                                placeholder="0.00"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 text-sm">
                        ...
                        <div>
                            <label for="userSearchTerm" class="block text-sm font-medium text-gray-700 mb-1">Recipient User *</label>
                            <div class="relative">
                                <input type="text" wire:model.live="userSearchTerm" wire:keyup="searchUsersForTransfer"
                                    id="userSearchTerm" placeholder="Search by name or email..."
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 text-sm">
                            ...
                            @error('transferToUserId') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                        </div>

                        <!-- To Wallet -->
                        <div>
                            <label for="transferToWalletType" class="block text-sm font-medium text-gray-700 mb-1">To Wallet *</label>
                            ...
                            @error('transferToWalletType') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                        </div>

                        <!-- Description -->
                        <div>
                            <label for="transferDescription" class="block text-sm font-medium text-gray-700 mb-1">Description *</label>
                            ...
                            @error('transferDescription') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                        </div>
                    </div>
