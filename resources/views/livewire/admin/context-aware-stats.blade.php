<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-4">
    ...
    <div class="bg-white border border-gray-100 shadow-sm rounded-lg relative overflow-hidden hover:shadow-md transition-shadow">
        ...
        <div class="p-3 sm:p-4">
            <div class="flex items-center">
                ...
                <div class="min-w-0 flex-1">
                    ...
                    <p class="text-lg sm:text-xl font-bold text-gray-800 truncate">{{ number_format($stats['total_users'] ?? 0) }}</p>
    ...
    @if ($context === 'all' || $context === 'crypto')
            ...
            <div class="p-3 sm:p-4">
                <div class="flex items-center">
                    ...
                    <div class="min-w-0 flex-1">
                        ...
                        <p class="text-lg sm:text-xl font-bold text-gray-800 truncate">{{ number_format($stats['total_orders'] ?? 0) }}</p>
                        <div class="flex flex-col sm:flex-row sm:items-center mt-1 text-xs gap-1 sm:gap-2">
                            <span class="text-green-500 flex items-center">
                                <span class="inline-flex h-1.5 w-1.5 sm:h-2 sm:w-2 rounded-full bg-green-500 mr-1"></span>
                            ...
                            <span class="text-orange-500 flex items-center">
                                <span class="inline-flex h-1.5 w-1.5 sm:h-2 sm:w-2 rounded-full bg-orange-500 mr-1"></span>
        ...
        <div class="bg-white border border-gray-100 shadow-sm rounded-lg relative overflow-hidden hover:shadow-md transition-shadow">
            ...
            <div class="p-3 sm:p-4">
                <div class="flex items-center">
                    <div class="p-2 sm:p-3 rounded-full bg-purple-100 text-purple-600 mr-3 sm:mr-4 flex-shrink-0">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 sm:h-6 sm:w-6" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="min-w-0 flex-1">
                        <p class="text-gray-500 text-xs sm:text-sm font-medium">Wallet Balances</p>
                        <p class="text-lg sm:text-xl font-bold text-gray-800 truncate">
                            ₦{{ number_format(($stats['crypto_wallet_balance'] ?? 0) + ($stats['fiat_wallet_balance'] ?? 0), 2) }}</p>
                        <div class="flex flex-col sm:flex-row sm:items-center mt-1 text-xs gap-1 sm:gap-2">
                            <span class="text-blue-500">
                                Crypto: ₦{{ number_format($stats['crypto_wallet_balance'] ?? 0) }}
                            </span>
            ...
            <div class="p-3 sm:p-4">
                <div class="flex items-center">
                    ...
                    <div class="min-w-0 flex-1">
                        ...
                        <p class="text-lg sm:text-xl font-bold text-gray-800 truncate">{{ number_format($stats['total_assets'] ?? 0) }}</p>
                        <div class="flex flex-col sm:flex-row sm:items-center mt-1 text-xs gap-1 sm:gap-2">
                            <span class="text-green-500 flex items-center">
                                <span class="inline-flex h-1.5 w-1.5 sm:h-2 sm:w-2 rounded-full bg-green-500 mr-1"></span>
            ...
            <div class="p-3 sm:p-4">
                <div class="flex items-center">
                    ...
                    <div class="min-w-0 flex-1">
                        ...
                        <p class="text-lg sm:text-xl font-bold text-gray-800 truncate">{{ number_format($stats['total_transactions'] ?? 0) }}</p>
                        <div class="flex flex-col sm:flex-row sm:items-center mt-1 text-xs gap-1 sm:gap-2">
                            <span class="text-green-500 flex items-center">
                                <span class="inline-flex h-1.5 w-1.5 sm:h-2 sm:w-2 rounded-full bg-green-500 mr-1"></span>
            ...
            <div class="p-3 sm:p-4">
                <div class="flex items-center">
                    ...
                    <div class="min-w-0 flex-1">
                        ...
                        <p class="text-lg sm:text-xl font-bold text-gray-800 truncate">₦{{ number_format($stats['total_transaction_volume'] ?? 0, 2) }}</p>
                        <div class="flex flex-col sm:flex-row sm:items-center mt-1 text-xs gap-1 sm:gap-2">
                            <span class="text-blue-500">
            ...
            <div class="p-3 sm:p-4">
                <div class="flex items-center">
                    ...
                    <div class="min-w-0 flex-1">
                        ...
                        <p class="text-lg sm:text-xl font-bold text-gray-800 truncate">₦{{ number_format($stats['nuban_wallet_balance'] ?? 0, 2) }}</p>
                        @if($context === 'all')
                            <div class="mt-1 text-xs text-gray-500">
