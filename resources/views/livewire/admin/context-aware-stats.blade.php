        ...
        <div class="bg-white border border-gray-100 shadow-md rounded-lg relative overflow-hidden">
            ...
            <div class="p-4">
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="text-gray-500 text-sm font-medium">Wallet Balances</p>
        ...
        <div class="bg-white border border-gray-100 shadow-md rounded-lg relative overflow-hidden">
            ...
            <div class="p-4">
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="text-gray-500 text-sm font-medium">Assets</p>
                        <p class="text-xl font-bold text-gray-800">{{ number_format($stats['total_assets'] ?? 0) }}</p>
                        <div class="flex items-center mt-1 text-xs">
                            <span class="text-green-500 flex items-center mr-2">
                                <span class="inline-flex h-2 w-2 rounded-full bg-green-500 mr-1"></span>
                            ...
                            <span class="text-gray-500">
                                Avg order: ₦{{ number_format($stats['avg_order_value'] ?? 0, 0) }}
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="p-4">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-xl font-bold text-gray-800">{{ number_format($stats['total_transactions'] ?? 0) }}</p>
                        <div class="flex items-center mt-1 text-xs space-x-2">
                            <span class="text-green-500 flex items-center">
                                <span class="inline-flex h-2 w-2 rounded-full bg-green-500 mr-1"></span>
        ...
        <div class="bg-white border border-gray-100 shadow-md rounded-lg relative overflow-hidden">
            ...
            <div class="p-4">
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="text-gray-500 text-sm font-medium">Transaction Volume</p>
                        <p class="text-xl font-bold text-gray-800">₦{{ number_format($stats['total_transaction_volume'] ?? 0, 2) }}</p>
                        <div class="flex items-center mt-1 text-xs space-x-2">
                            <span class="text-blue-500">
            ...
            <div class="p-4">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-xl font-bold text-gray-800">₦{{ number_format($stats['nuban_wallet_balance'] ?? 0, 2) }}</p>
                        @if($context === 'all')
                            <div class="mt-1 text-xs text-gray-500">
