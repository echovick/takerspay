<div>
    ...
    <hr class="my-4">
    <livewire:rates-card />
    <p class="text-center text-[10px] mb-5 w-100 text-slate-400 mx-auto">To ensure your order is fufilled, please provide
                    ...
                    <div class="flex items-start gap-2.5 mt-3">
                        ...
                        <div class="flex flex-col gap-1 w-full max-w-[320px] ml-1">
                            <div class="flex items-center space-x-2 rtl:space-x-reverse">
                                ...
                                <span class="text-xs font-normal text-gray-500 dark:text-gray-400">11:46</span>
                            </div>
                            <div
                    ...
                    <div class="flex items-start gap-2.5 justify-end mt-3">
                        ...
                        <div class="flex flex-col gap-1 w-full max-w-[320px] mr-1">
                            <div class="flex items-center justify-end space-x-2 space-x-reverse">
                                <span class="text-xs font-normal text-gray-500 dark:text-gray-400 px-2">11:46</span>
                                <span class="text-sm font-semibold text-gray-900 dark:text-white">You</span>
                            </div>
                            <div
                                class="flex flex-col leading-1.5 p-4 border-gray-200 bg-blue-100 rounded-s-xl rounded-es-xl dark:bg-blue-700">
                                <p class="text-xs font-normal text-gray-900 dark:text-white">
                                    {{ $item['text'] }}
                                </p>
                            </div>
                            <span class="text-xs font-normal text-gray-500 dark:text-gray-400 text-right">Seen</span>
                        </div>
                        <!-- Avatar -->
                        <img class="w-8 h-8 rounded-full"
                            src="https://flowbite.com/docs/images/people/profile-picture-5.jpg" alt="Your image">
                    </div>
                @endif
            @endforeach
        @endif
