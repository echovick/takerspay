<form class="space-y-4 md:space-y-6" wire:submit.prevent="login">
    ...
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('forgot-password') }}"
            class="text-sm font-medium text-primary-1000 hover:underline dark:text-primary-500">Forgot password?</a>
    </div>
    <button type="submit"
        ...
        Sign in
        <svg wire:loading wire:loading.target="login" aria-hidden="true" role="status"
