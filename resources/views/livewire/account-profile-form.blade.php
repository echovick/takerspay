<div>
    ...
    <div
        class="w-full max-w p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700 mt-3">
        <form class="space-y-4 md:space-y-6" wire:submit="updateProfile">
            ...
            <div>
                <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">User
                    Tag</label>
                <input type="text" name="password" id="password" placeholder="@echovick" wire:model.fill="tag"
            ...
            <div>
                ...
                <input type="email" name="password" id="password" placeholder="johndoe@takerspay.com"
            ...
            <div>
                <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Phone
                    Number</label>
                <input type="text" name="password" id="password" placeholder="+2348131117278"
                    wire:model.fill="phone"
                    class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                @error('phone')
                    <small class="text-red-600">{{ $message }}</small>
                @enderror
            ...
            <button type="submit"
                ...
                Submit
                <svg wire:loading wire:loading.target="updateProfile" aria-hidden="true" role="status"
