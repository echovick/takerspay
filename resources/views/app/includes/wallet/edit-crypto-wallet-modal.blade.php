<!-- Main modal -->
<div id="edit-crypto-wallet-modal" tabindex="-1" aria-hidden="true" wire:ignore.self
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="edit-crypto-wallet-modal">
            ...
            <!-- Modal body -->
            <form class="max-w-sm mx-auto" wire:submit.prevent="updateCryptoWallet">
                ...
                <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                    <button type="submit"
                        ...
                        Submit
                        <svg wire:loading wire:loading.target="updateCryptoWallet" aria-hidden="true" role="status"
                    ...
                    <button data-modal-hide="edit-crypto-wallet-modal" type="button"
